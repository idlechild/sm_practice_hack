...
preset_load_preset:
{
  ...
  .category_preset
    ...
    %a8()
    LDA.l $700002,X : AND !eram_safeties_enabled_msb : STA !eram_safeties_enabled_msb
    ...
    LDA !eram_safeties_enabled_msb : AND #$01 : STA !eram_apply_safeties_enable_flags+$20
    LDA !eram_safeties_enabled_msb : AND #$02 : STA !eram_apply_safeties_enable_flags+$22
    LDA !eram_safeties_enabled_msb : AND #$04 : STA !eram_apply_safeties_enable_flags+$24
    LDA !eram_safeties_enabled_msb : AND #$08 : STA !eram_apply_safeties_enable_flags+$26
    LDA !eram_safeties_enabled_msb : AND #$10 : STA !eram_apply_safeties_enable_flags+$28
    LDA !eram_safeties_enabled_msb : AND #$20 : STA !eram_apply_safeties_enable_flags+$2A
    LDA !eram_safeties_enabled_msb : AND #$40 : STA !eram_apply_safeties_enable_flags+$2C
    LDA !eram_safeties_enabled_msb : AND #$80 : STA !eram_apply_safeties_enable_flags+$2E
  ...
  .safeties_next
    ...
    INX #2 : CPX #$0030 : BMI .safeties_loop
  .safeties_done
  ...
  .safeties_adjust_select_item
    LDA !eram_safeties_selected_item,X : BEQ .safeties_adjust_done
...
category_preset_load:
{
  ...
  .verifyLength
    ...
    ; This would require over 800 presets in the stack,
