...
presets_goto_kpdr_brinstar:
  ...
  .routine
    LDA !sram_safeties_enabled_kpdr : BIT #$0001 : BEQ .done
    LDY #presets_submenu_kpdr_brinstar_spazer
  .done
    JML action_submenu

presets_goto_kpdr_kraid:
    %cm_submenu("Kraid's Lair", #presets_submenu_kpdr_kraid)

presets_goto_kpdr_upper_norfair:
    %cm_submenu("Upper Norfair", #presets_submenu_kpdr_upper_norfair)
...
presets_goto_kpdr_maridia:
    %cm_submenu("Maridia", #presets_submenu_kpdr_maridia)

presets_goto_kpdr_upper_norfair_revisit:
    %cm_submenu("Upper Norfair Revisit", #presets_submenu_kpdr_upper_norfair_revisit)
...
presets_goto_kpdr_safeties:
    %cm_submenu("Safeties", #presets_submenu_kpdr_safeties)
...
presets_submenu_kpdr_upper_norfair_revisit:
    ...
    dw #$FFFF
    dw #presets_kpdr_upper_norfair_revisit_purple_shaft_upper
    dw #presets_kpdr_upper_norfair_revisit_magdollite_tunnel_upper
    dw #presets_kpdr_upper_norfair_revisit_kronic_boost_upper
    dw #$FFFF
    dw #presets_kpdr_upper_norfair_revisit_croc_speedway_lower
    dw #presets_kpdr_upper_norfair_revisit_spiky_acid_snakes_lower
    dw #presets_kpdr_upper_norfair_revisit_kronic_boost_lower
    dw #$0000
...
presets_submenu_kpdr_safeties:
    ...
    dw #presets_kpdr_safeties_nutella_refill
    dw #presets_kpdr_safeties_screw_attack
    dw #presets_kpdr_safeties_ridley_etank
    dw #presets_kpdr_safeties_baby_skip_skip
    dw #$0000
    %cm_header("SAFETIES")
...
presets_kpdr_upper_norfair_revisit_purple_shaft_upper:
    %cm_preset("Purple Shaft (Upper)", #preset_names_purple_shaft_upper, #preset_kpdr_upper_norfair_revisit_purple_shaft_upper)

presets_kpdr_upper_norfair_revisit_magdollite_tunnel_upper:
    %cm_preset("Magdollite Tunnel (Upper)", #preset_names_magdollite_tunnel_upper, #preset_kpdr_upper_norfair_revisit_magdollite_tunnel_upper)

presets_kpdr_upper_norfair_revisit_kronic_boost_upper:
    %cm_preset("Kronic Boost (Upper)", #preset_names_kronic_boost_upper, #preset_kpdr_upper_norfair_revisit_kronic_boost_upper)

presets_kpdr_upper_norfair_revisit_croc_speedway_lower:
    %cm_preset("Croc Speedway (Lower)", #preset_names_croc_speedway_lower, #preset_kpdr_upper_norfair_revisit_croc_speedway_lower)

presets_kpdr_upper_norfair_revisit_spiky_acid_snakes_lower:
    %cm_preset("Spiky Acid Snakes (Lower)", #preset_names_spiky_acid_snakes_lower, #preset_kpdr_upper_norfair_revisit_spiky_acid_snakes_lower)

presets_kpdr_upper_norfair_revisit_kronic_boost_lower:
    %cm_preset("Kronic Boost (Lower)", #preset_names_kronic_boost_lower, #preset_kpdr_upper_norfair_revisit_kronic_boost_lower)
...
presets_kpdr_safeties_spazer:
    %cm_safety($000001, "Spazer", #preset_names_spazer, !sram_safeties_enabled_kpdr)

presets_kpdr_safeties_kraid_etank:
    %cm_safety($000002, "Kraid E-Tank", #preset_names_kraid_etank, !sram_safeties_enabled_kpdr)

presets_kpdr_safeties_hjb_missiles:
    %cm_safety($000004, "HJB Missiles", #preset_names_hjb_missiles, !sram_safeties_enabled_kpdr)

presets_kpdr_safeties_speed_missiles:
    %cm_safety($000008, "Speed Missiles", #preset_names_speed_missiles, !sram_safeties_enabled_kpdr)

presets_kpdr_safeties_grapple:
    %cm_safety($000010, "Grapple", #preset_names_grapple, !sram_safeties_enabled_kpdr)

presets_kpdr_safeties_crocomire_etank:
    %cm_safety($000020, "Crocomire E-Tank", #preset_names_crocomire_etank, !sram_safeties_enabled_kpdr)

presets_kpdr_safeties_sloaters_refill:
    %cm_safety($000040, "Sloaters Refill", #preset_names_sloaters_refill, !sram_safeties_enabled_kpdr)

presets_kpdr_safeties_moat_missiles:
    %cm_safety($000080, "Moat Missiles", #preset_names_moat_missiles, !sram_safeties_enabled_kpdr)

presets_kpdr_safeties_crab_supers:
    %cm_safety($000100, "Crab Supers", #preset_names_crab_supers, !sram_safeties_enabled_kpdr)

presets_kpdr_safeties_aqueduct_missiles:
    %cm_safety($000200, "Aqueduct Missiles", #preset_names_aqueduct_missiles, !sram_safeties_enabled_kpdr)

presets_kpdr_safeties_aqueduct_supers:
    %cm_safety($000400, "Aqueduct Supers", #preset_names_aqueduct_supers, !sram_safeties_enabled_kpdr)

presets_kpdr_safeties_nutella_refill:
    %cm_safety($000800, "Nutella Refill", #preset_names_nutella_refill, !sram_safeties_enabled_kpdr)

presets_kpdr_safeties_screw_attack:
    %cm_safety($001000, "Screw Attack", #preset_names_screw_attack, !sram_safeties_enabled_kpdr)

presets_kpdr_safeties_ridley_etank:
    %cm_safety($002000, "Ridley E-Tank", #preset_names_ridley_etank, !sram_safeties_enabled_kpdr)

presets_kpdr_safeties_baby_skip_skip:
    %cm_safety($004000, "Baby Skip Skip", #preset_names_baby_skip_skip, !sram_safeties_enabled_kpdr)
