...
; 000001 = Safeties (Spazer)
; 000002 = Safeties (Kraid E-Tank)
; 000004 = Safeties (HJB Missiles)
; 000008 = Safeties (Speed Missiles)
; 000010 = Safeties (Grapple)
; 000020 = Safeties (Crocomire E-Tank)
; 000040 = Safeties (Sloaters Refill)
; 000080 = Safeties (Moat Missiles)
; 000100 = Safeties (Crab Supers)
; 000200 = Safeties (Aqueduct Missiles)
; 000400 = Safeties (Aqueduct Supers)
; 000800 = Safeties (Nutella Refill)
; 001000 = Safeties (Screw Attack)
; 002000 = Safeties (Ridley E-Tank)
; 004000 = Safeties (Baby Skip Skip)
...
preset_kpdr_brinstar_passing_through_maridia:
    ...
    dw $0FE0, $0001  ; Safeties (Spazer) missiles adjustment
    dw $1010, $FFFF  ; Safeties (Spazer) supers adjustment
    dw #$FFFF
...
preset_kpdr_kraid_warehouse_zeelas:
    ...
    dw $1010, $0001  ; Safeties (Spazer) supers adjustment
    dw #$FFFF
...
preset_kpdr_kraid_fallen_hero:
    ...
    dw $0AFA, $008B  ; Samus Y
    dw $0FE0, $0002  ; Safeties (Spazer) missiles adjustment
    dw $1010, $0000  ; Safeties (Spazer) supers adjustment
    dw $D8B8, $0004  ; Doors
    dw #$FFFF
...
preset_kpdr_kraid_business_center_preelev:
    ...
    dw $0F82, $004B  ; Safeties (Kraid E-Tank) energy adjustment
    dw #$FFFF
...
preset_kpdr_upper_norfair_leaving_hijump:
    ...
    dw $0AFA, $008B  ; Samus Y
    dw $0F82, $0000  ; Safeties (Kraid E-Tank) energy adjustment
    dw $D876, $0121  ; Items
    dw $D8BA, $0001  ; Doors
    dw #$FFFF
...
preset_kpdr_upper_norfair_revisit_purple_shaft_upper:
...
preset_kpdr_upper_norfair_revisit_magdollite_tunnel_upper:
    dw #preset_kpdr_upper_norfair_revisit_purple_shaft_upper ; Upper Norfair Revisit: Purple Shaft (Upper)
    dw $078D, $9576  ; DDB
    dw $079B, $AEDF  ; MDB
...
preset_kpdr_upper_norfair_revisit_kronic_boost_upper:
    dw #preset_kpdr_upper_norfair_revisit_magdollite_tunnel_upper ; Upper Norfair Revisit: Magdollite Tunnel (Upper)
    dw $078D, $96BA  ; DDB
    dw $079B, $AEB4  ; MDB
    dw $090F, $8000  ; Screen subpixel X position
    dw $0911, $0200  ; Screen X position in pixels
...
preset_kpdr_upper_norfair_revisit_croc_speedway_lower:
    dw #preset_kpdr_upper_norfair_revisit_ice_escape ; Upper Norfair Revisit: Ice Escape
    dw $078D, $9336  ; DDB
    dw $079B, $A8F8  ; MDB
...
preset_kpdr_upper_norfair_revisit_spiky_acid_snakes_lower:
    dw #preset_kpdr_upper_norfair_revisit_croc_speedway_lower ; Upper Norfair Revisit: Croc Speedway (Lower)
    dw $078D, $93C6  ; DDB
    dw $079B, $AFCE  ; MDB
    dw $090F, $A000  ; Screen subpixel X position
...
preset_kpdr_upper_norfair_revisit_kronic_boost_lower:
    dw #preset_kpdr_upper_norfair_revisit_spiky_acid_snakes_lower ; Upper Norfair Revisit: Spiky Acid Snakes (Lower)
    dw $078D, $9792  ; DDB
    dw $079B, $AFFB  ; MDB
    dw $090F, $B000  ; Screen subpixel X position
    dw $0911, $0300  ; Screen X position in pixels
    ...
    dw $0F78, $0FCF  ; Safeties enabled
    dw #$FFFF

preset_kpdr_lower_norfair_ln_main_hall:
    dw #preset_kpdr_upper_norfair_revisit_kronic_boost_upper ; Upper Norfair Revisit: Kronic Boost (Upper)
    dw $078D, $96F6  ; DDB
    dw $079B, $B236  ; MDB
