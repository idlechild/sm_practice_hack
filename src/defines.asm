...
!sram_safeties_enabled_kpdr = !SRAM_START+$B4
!sram_safeties_enabled_msb_kpdr = !SRAM_START+$B6
...
!eram_safeties_enabled             = !ENEMY_ID
!eram_safeties_enabled_msb         = !ENEMY_ID+$2
!eram_safeties_energy              = !ENEMY_ID+$8
!eram_safeties_reserves            = !ENEMY_ID+$38
!eram_safeties_missiles            = !ENEMY_ID+$68
!eram_safeties_supers              = !ENEMY_ID+$98
!eram_safeties_pbs                 = !ENEMY_ID+$C8
!eram_safeties_unequip_items       = !ENEMY_ID+$F8
!eram_safeties_unequip_beams       = !ENEMY_ID+$128
!eram_safeties_selected_item       = !ENEMY_ID+$158
!eram_category_preset_stack        = !ENEMY_ID+$188
...
!eram_apply_safeties_combo_flag    = !ENEMY_ID+$230
!eram_apply_safeties_selected_item = !ENEMY_ID+$232
