...
init_heat_damage_ram:
{
  ...
  .heatShield
    LDA !ROOM_ID : CMP #ROOM_LowerNorfairSaveRoom+1 : BPL .noDamage
    CMP #ROOM_LavaDiveRoom-1 : BMI .noDamage
    CMP #ROOM_LNElevatorSaveRoom-1 : BPL .heatShieldDamage
    CMP #ROOM_LowerNorfairElevator+1 : BPL .noDamage
...
init_physics_non_vanilla:
{
  ...
  .pv
    LDA !ROOM_ID : CMP #ROOM_BowlingAlley-1 : BMI .pv_more
    CMP #ROOM_WestSandHole-1 : BMI .off
    CMP #ROOM_ShaktoolRoom+1 : BPL .pv_on
  ...
  .pv_more
    ...
    CMP #ROOM_StatuesHallway+2 : BPL .pv_on
    CMP #ROOM_CrateriaSuperRoom+1 : BPL .off
    CMP #ROOM_GauntletETankRoom-1 : BPL .pv_on
    CMP #ROOM_CrateriaPowerBombs+1 : BMI .pv_on
    BRA .off
}
