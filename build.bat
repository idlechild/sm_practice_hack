...
python create_ips.py ..\build\00.sfc ..\build\ff.sfc ..\build\HACK_InfoHUD_2.5.X.ips
...
python create_ips.py ..\build\00.sfc ..\build\ff.sfc ..\build\HACK_InfoHUD_Savestates_2.5.X.ips
